...
Pod::Spec.new do |s|
  s.name             = 'MyPod'
  s.version          = '0.1.0'
  s.summary          = 'Demonstration of pod usage '
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ganeshfaterpekar/MyPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ganeshfaterpekar' => 'ganeshfaterpekar@gmail.com' }
  s.source           = { :git => 'https://github.com/ganeshfaterpekar/MyPod.git', :tag => s.version.to_s }
